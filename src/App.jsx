  ...
  return (
    ...
    <Navbar/> 
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-3xl'>DailyList - Manage your todos at one place</h1>
         ...
         <input className='my-4 cursor-pointer' id='show' onChange={toggleFinished} type="checkbox" checked={showFinished} /> 
